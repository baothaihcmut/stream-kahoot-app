...
export const GOOGLE_OAUTH_CLIENT_ID_CONFIG_KEY = 'google.clientId';
export const GOOGLE_OAUTH_SECRET_CONFIG_KEY = 'google.secret';
export const GOOGLE_OAUTH_CALLBACK_URL = 'google.callbackUrl';
